...
def generate(max_len, title, context):
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--title', type=str, default='第一次试吃东北铁岭青皮榛子，确实有意思！', help='作文标题')
    # parser.add_argument('--context', type=str, default='第一次试吃东北铁岭青皮榛子，确实有意思！', help='作文上文')
    parser.add_argument('--input', default=r'F:\gitlab\material\cpm\data\xianji')
    ...
    with open("./output.txt", "r", encoding='utf-8') as f_txt:
        with open(args.input, "r", encoding='utf-8') as f:
            for line in f.readlines():
                result = generate(args.max_len, line, line)
